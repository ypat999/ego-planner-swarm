...
def generate_launch_description():
    xtd_ns = LaunchConfiguration('xtd_ns', default='x500_0')
    ...
    xtd_ns_arg = DeclareLaunchArgument('xtd_ns', default_value=xtd_ns, description='XTDrone2 namespace')
    ...
    ego_planner_node = Node(
        ...
        output='screen',
        remappings=[
            ('odom_world', [xtd_ns, '/', odometry_topic]),  #TODO
            ('planning/bspline', [xtd_ns, '/planning/bspline']),
            ('planning/data_display', [xtd_ns, '/planning/data_display']),
            ('planning/broadcast_bspline_from_planner', '/broadcast_bspline'),
            ('planning/broadcast_bspline_to_planner', '/broadcast_bspline'),
            
            ('goal_point', [xtd_ns, '/plan_vis/goal_point']),
            ('global_list', [xtd_ns, '/plan_vis/global_list']),
            ('init_list', [xtd_ns, '/plan_vis/init_list']),
            ('optimal_list', [xtd_ns, '/plan_vis/optimal_list']),
            ('a_star_list', [xtd_ns, '/plan_vis/a_star_list']),
            
            ('grid_map/odom', [xtd_ns, '/', odometry_topic]),
